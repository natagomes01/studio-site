...
export const en: Strings = {
  ...
  langSwitch: {
    detectedBanner: 'Versão em português disponível',
    detectedAction: 'Mudar para português',
    dismiss: 'Close',
  },
  hero: {
  ...
  cases: {
    ...
    items: [
      ...
      },
      {
        ...
        segment: 'Topographic engineering equipment',
        stats: [
  ...
  form: {
    ...
    contextLabel: 'Where is your operation stuck today?',
    contextPlaceholder:
      'In a few lines: lead volume, current team, main bottleneck.',
