...
export const ptBr: Strings = {
  ...
  langSwitch: {
    detectedBanner: 'English version available',
    detectedAction: 'Switch to English',
    dismiss: 'Fechar',
  },
  hero: {
    eyebrow: 'Albatroz Studio · Inteligência em Vendas',
    headlineLine1: 'Você não está perdendo cliente por falta de marketing.',
    headlineLine2: 'Está perdendo por falta de estrutura no atendimento.',
    subheadline:
  ...
  proofBar: [
    ...
    { metric: 'R$ 3,5M', context: 'em vendas/mês · Topografia com Você' },
    { metric: '680', context: 'atendimentos em 3 meses · Cirurgia plástica' },
  ],
  pain: {
    eyebrow: '01 · O que trava sua operação hoje',
    headlineLine1: 'Não é falta de cliente.',
    headlineLine2: 'É falta de estrutura.',
    intro:
    ...
    items: [
      {
        ...
        body: 'O contato chega, o time está ocupado, o concorrente responde primeiro. A venda não foi perdida no preço. Foi perdida no tempo.',
      },
      {
  ...
  cases: {
    ...
    headlineLine1: 'Quando a operação vira sistema,',
    headlineLine2: 'o crescimento aparece.',
    intro:
    ...
    items: [
      {
        ...
        stats: [
          { value: '80+', label: 'atendimentos/dia no WhatsApp' },
          { value: '15K+', label: 'mulheres atendidas no histórico' },
        ],
        body: 'Uma referência de porte: mais de 15 mil mulheres já atendidas pela clínica ao longo de sua história. Hoje, com o PAI ativo, a operação sustenta mais de 80 atendimentos por dia no WhatsApp sem travar e sem perder o tom humano da marca. Volume que, no modelo manual, exigiria triplicar o time de atendimento.',
        accent: 'linear-gradient(135deg, #6b3a3a 0%, #a85957 100%)',
      },
      {
        name: 'Gracie Barra São Gonçalo',
      ...
      },
      {
        ...
        stats: [
          ...
          { value: '0', label: 'gargalo no agendamento' },
        ],
    ...
    pattern: {
      ...
      body: 'Em todos os casos, o ponto de virada não foi mais tráfego, mais anúncio ou mais vendedor. Foi a estrutura por trás do atendimento.',
    },
    cta: 'Quero um diagnóstico para a minha empresa',
  },
  protocol: {
    eyebrow: '03 · Como o PAI é aplicado na sua empresa',
    headlineLine1: 'Não é uma ferramenta.',
    headlineLine2: 'É uma implantação.',
    intro:
    ...
    steps: [
      {
        ...
        body: 'Mapeamos o fluxo de vendas, identificamos onde o dinheiro está vazando e desenhamos o protocolo específico para o seu negócio. Sem template genérico, sem copiar do concorrente.',
      },
      {
        title: 'Treinamento da inteligência em vendas',
        body: 'A IA é treinada com a sua linguagem, suas objeções reais, seus diferenciais e seu processo comercial. Ela vende como a sua empresa vende. Não como um chatbot qualquer falando em nome da sua marca.',
      },
      {
        title: 'Implantação no WhatsApp e canais de venda',
        body: 'Atendimento ativo 24h, qualificação automática, condução do contato até o ponto de fechamento. Tudo integrado ao canal onde o cliente já está, sem migrar ninguém para sistema novo.',
      },
      {
        title: 'Integração com a equipe humana',
        body: 'A IA não substitui o vendedor. Ela entrega o contato pronto, no momento certo, com o contexto completo. O time humano fecha, com mais tempo, mais informação e menos atrito. O vendedor para de ser atendente e volta a ser vendedor.',
      },
      {
        title: 'Otimização contínua',
        body: 'Acompanhamos o comportamento real dos contatos, ajustamos o protocolo e elevamos a conversão semana após semana. Implantação viva, não entrega única.',
      },
    ],
    closing:
  ...
  footer: {
    ...
    address: {
      line1: 'Avenida Gisele Constantino, 164, Sala 7A',
  ...
  form: {
    ...
    contextLabel: 'Onde sua operação está travando hoje?',
    contextPlaceholder:
    ...
    error: 'Algo deu errado no envio. Tente novamente ou escreva para nata@albatroz.studio.',
  },
};
